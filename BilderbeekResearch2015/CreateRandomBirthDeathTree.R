...
plot(tree_full,main=paste("Full birth-death tree\nbirth rate = ",birth_rate, ", death rate = ", death_rate))
dev.off()

png(filename="CreateRandomBirthDeathTreeReconstructed.png")
plot(tree_reconstructed,main=paste("Reconstructed birth-death tree\nbirth rate = ",birth_rate, ", death rate = ", death_rate))
dev.off()
...
ltt.plot(
	tree_full,
	main=paste("LTT plot of full birth-death tree\nbirth rate = ",birth_rate, ", death rate = ", death_rate),
...
ltt.plot(
	tree_reconstructed,
	main=paste("LTT plot of reconstructed birth-death tree\nbirth rate = ",birth_rate, ", death rate = ", death_rate),
	ylab="Number of lineages"
)
dev.off()
